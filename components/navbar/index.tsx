...
const Navbar = () => {
  return (
    <div>
      <header className="fixed inset-x-0 z-20 mx-auto mb-4 px-4 transition-all duration-1000 animate-out sm:top-0 sm:h-16 sm:px-0 sm:transition-none top-4 animate-in">
