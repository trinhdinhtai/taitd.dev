...
### 6: Gộp nhiều commit lại thành 1 commit
...
## VII. Tình huống 7: đổi tên branch
...
git cherry-pick là một lệnh git hữu ích dùng cho trường hợp muốn merge commit bất kỳ vào nhánh khác thay vì toàn bộ branch (git cherry-pick thường bị conflict, dùng lệnh git add . và git commit -m “message” là xử lý được)
