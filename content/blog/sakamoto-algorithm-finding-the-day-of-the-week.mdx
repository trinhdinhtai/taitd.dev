...
Tuy nhiên đấy mới là trong 1 năm, 1 năm không nhuận có 365 = 52 \* 7 + 1, tức là mỗi 1 năm trôi qua thì lại có 1 ngày dôi ra, vậy nếu ta có `y` năm thì có `y` ngày cần cộng thêm.
...
Okey chúng ta đã thêm số ngày nhuận cần thiết rồi, nhưng vấn đề là ngày nhuận là ngày 29 tháng 2 chứ không phải là ngày 0 tháng 1, tức là chúng ta không cần đưa hai tháng đầu tiên (Tháng 1 và tháng 2) của năm vào tính toán vì ngày nhuận không ảnh hưởng gì đến nó, mà sẽ phải đẩy lùi về năm trước đó. Tức là chúng ta sẽ có công thức:

`y -= m < 3` - Nếu tháng nhỏ hơn 3 (Tháng 1 và Tháng 2) thì lùi năm hiện tại về năm trước đó.
